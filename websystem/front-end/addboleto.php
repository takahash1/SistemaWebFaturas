...
<body>	
		<div id="formularioMenu">
			<h3>Digite os dados do boleto</h3>
			<h3>que deseja adicionar:</h3>
			<form action="usuarios.php" method="POST">
				...
				<input id="inpHome" type="date" name="data" placeholder="Vencimento: DD/MM/AAAA">			
				<input id="inpHome" type="submit" name="buscar" value="Adicionar">
			</form>
		</div>		
			<div id="dados">
				<table class="table">				
